...
- Dùng Geist cho nội dung và tiêu đề trên toàn bộ trang, fallback Inter và system-ui; dùng Geist Mono cho mã nguồn (code block và inline code), Markdown editor và trường slug, fallback ui-monospace, SFMono-Regular, Menlo và monospace. Font được self-host qua Next.js font loader, dùng font-display swap và hỗ trợ tiếng Việt. Giữ khoảng trắng rộng và màu sắc neutral tiết chế. Thiết kế dùng Tailwind CSS 4 và semantic CSS variables của shadcn/ui, với góc gần vuông và không có card/shadow trang trí.
